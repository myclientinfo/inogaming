...
a {color: #006699;}
body {width: 100%; margin: 0px; background-color: #3c3c3c; font: 11px tahoma; text-align: center;}
...
#outerBorder {width: 997px; margin: 0px auto;background-color: black;}
#outerBody {width: 995px; text-align: left; margin: 0px auto; }
#footer, #header {width: 100%; height: 30px; background-color: red; display: none;}

#bodyContainer {width: 100%;  margin: 0px auto; background-color: white; text-align: left;}
#bodyLeft {width: 262px; float: left; border: 0px solid black; border-right-width: 1px; background-color:  #114e08; }
...
#inputFormForm .formDark, #data_form .formDark {background-color: #114E08; color: white; }
...
#footerContainer a {color: #ffffff; border: 0px solid white; border-right-width: 1px; padding-right: 7px; padding-left: 7px; text-decoration: none; }
...
.leftDivHeader {background-image: url('/images/bg_bar.gif'); border: 1px solid black; border-width: 1px 0px; height: 20px; padding-top: 0px;}
...
#data_details .label {width: 100px;display: block;float: left;}

#data_list, #rss_feeds, #changes {background-color: #114E08; color: white;}
...
#reviewSummaryBox, #reviewBox, #searchBox, #listBox {float: left; margin-bottom: 10px; width: 645px; background-color: #192346; color: white; padding: 10px; }
...
.reviewLinks1 {font-weight: bold; font-color: #006699;}

table.listing {margin: 0px auto;}
table.listing td {padding-bottom: 3px;padding-top: 3px; }

#ratingImage {float: left; margin-right: 10px; }

.upcomingEventType {font-weight: bold; color: #FFCC33; }
...
#latest_podcast, #whats_new div.leftDivContent {background-color: #192346; color: white; }
...
#latest_podcast div.leftDivContent img {margin-left: 6px; }
...
#inputFormForm{float: left;margin: 0px auto; width: 600px; position: relative; left: 60px;}
#inputFormForm div {margin: 0px; margin-bottom: 3px; padding: 5px 20px; color: white; font-weight: bold;}

/*
#inputFormForm div div.message {color: black; font-weight: normal; font-size: 9px; width: 430px; position: relative; left: 130px; margin: 0px;}
*/
...
div.reviewAvatar a {font-weight: bold; color: #000000; font-size: 10px;}
#reviewContent {margin-top: 22px;}
#promo_image {margin:10px 0px 0px 0px; }

.caption {color: #006699; font-weight: bold; font-size: 12px; text-align: center;}

#updateOuter{margin: 0px auto; border: 0px solid blue; width: 682px; text-align: center;}

div.reviewAvatar a {text-decoration: none;}
...
.review_link {color: #009900; font-weight: bold; margin-right: 4px;}
...
.10_questions_link {color: #669900; font-weight: bold; margin-right: 4px;}
...
#content {width: 710px; height: 200px; font-family: Courier New, Courier; font-size: 11px;}
