...
<label for="login_username">Username</label><input type="text" name="username" id="login_username" value="<?=(isset($_POST['username'])?$_POST['username']:(isset($_GET['un'])?$_GET['un']:''))?>"><br>
